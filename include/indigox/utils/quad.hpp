...
namespace stdx { // extended std namespace
  ...
  struct quad {
    ...
    inline void swap(quad &__p) noexcept(
  ...
  inline constexpr bool operator==(const quad<_T1, _T2, _T3, _T4> &__x,
  ...
  inline constexpr bool operator<(const quad<_T1, _T2, _T3, _T4> &__x,
    ...
    return __x.first < __y.first ||
           ...
           (!(__y.first < __x.first) && !(__y.second < __x.second) &&
            __x.third < __y.third) ||
           (!(__y.first < __x.first) && !(__y.second < __x.second) &&
            !(__y.third < __x.third) && __x.fourth < __y.fourth);
  }
  ...
  inline typename std::enable_if<
      std::is_swappable<_T1>::value && std::is_swappable<_T2>::value &&
          std::is_swappable<_T3>::value && std::is_swappable<_T4>::value,
      void>::type
  swap(quad<_T1, _T2, _T3, _T4> &__x, quad<_T1, _T2, _T3, _T4> &__y) noexcept(
  ...
  template <class _Tp> struct __make_quad_return_impl { typedef _Tp type; };
  ...
  template <class _Tp> struct __make_quad_return {
    typedef
        typename __make_quad_return_impl<typename std::decay<_Tp>::type>::type
            type;
  };

  template <class _T1, class _T2, class _T3, class _T4>
  inline constexpr quad<typename __make_quad_return<_T1>::type,
