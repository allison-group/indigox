...
String opt_::DATA_DIRECTORY = QUOTE(DFT_DATA_DIR);
String opt_::PERIODIC_TABLE_FILE = DFT_PERIODIC_TABLE_FILE;
...
std::set<String> assign_::ALLOWED_ELEMENTS = {DFT_ASSIGNELECTRON_ALLOWED_ELEMENTS};
...
String fpt_::LIBTW_JAR_FILE = DFT_ASSIGNELECTRON_FPT_JAR_FILE;
