...
void GenerateOptions(py::module &m) {
  ...
  PyAssElec.def_readwrite_static("ALGORITHM", &e_::ALGORITHM)
      ...
      .def_readwrite_static("AUTO_USE_ELECTRON_PAIRS",
                            &e_::AUTO_USE_ELECTRON_PAIRS)
      .def_readwrite_static("USE_CHARGED_BOND_ENERGIES",
                            &e_::USE_CHARGED_BOND_ENERGIES)
      .def_readwrite_static("ALLOWED_ELEMENTS", &e_::ALLOWED_ELEMENTS)
      .def_readwrite_static("HIGHEST_MAGNITUDE_CHARGE",
                            &e_::HIGHEST_MAGNITUDE_CHARGE)
  ...
  PyFPT.def_readwrite_static("LIBTW_JAR_FILE", &f_::LIBTW_JAR_FILE)
      ...
      .def_readwrite_static("MINIMUM_PROPAGATION_DEPTH",
                            &f_::MINIMUM_PROPAGATION_DEPTH);
