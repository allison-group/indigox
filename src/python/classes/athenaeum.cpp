...
void GeneratePyAthenaeum(py::module& m) {
  ...
  .def("GetFragments", py::overload_cast<const Molecule&>(&Athenaeum::GetFragments, py::const_), Ref)
  ...
  py::bind_map<std::map<Molecule, std::vector<Fragment>>>(m, "MapMoleculeVecFragment");
}
