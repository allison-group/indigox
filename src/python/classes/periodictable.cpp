...
void GeneratePyPeriodicTable(py::module &m) {
  ...
  .def("GetSingleCovalentRadius", &Element::GetSingleCovalentRadius)
  .def("GetDoubleCovalentRadius", &Element::GetDoubleCovalentRadius)
  .def("GetTripleCovalentRadius", &Element::GetTripleCovalentRadius)
  ...
  py::class_<PeriodicTable>(m, "PeriodicTable")
      ...
      .def("GetElement", py::overload_cast<const int32_t>(
                             &PeriodicTable::GetElement, py::const_))
      .def("GetElement", py::overload_cast<const std::string>(
                             &PeriodicTable::GetElement, py::const_))
      .def("__getitem__", py::overload_cast<const int32_t>(
                              &PeriodicTable::operator[], py::const_))
