...
void GeneratePyForcefield(py::module &m) {
  ...
  py::class_<Forcefield>(m, "Forcefield")
      ...
      .def("NewBondType", py::overload_cast<BondType, int32_t, double, double>(
                              &Forcefield::NewBondType))
      .def("LinkBondTypes", &Forcefield::LinkBondTypes)
      .def("ReserveBondTypes", &Forcefield::ReserveBondTypes)
      .def("NewAngleType",
           py::overload_cast<AngleType, int32_t, double, double>(
               &Forcefield::NewAngleType))
      .def("LinkAngleTypes", &Forcefield::LinkAngleTypes)
      .def("ReserveAngleTypes", &Forcefield::ReserveAngleTypes)
      .def("NewDihedralType",
           py::overload_cast<DihedralType, int32_t, double, double, double>(
               &Forcefield::NewDihedralType))
      .def("NewDihedralType",
           py::overload_cast<DihedralType, int32_t, double, double>(
               &Forcefield::NewDihedralType))
      .def("ReserveDihedralTypes", &Forcefield::ReserveDihedralTypes)
      .def("GetAtomType",
           py::overload_cast<std::string>(&Forcefield::GetAtomType, py::const_))
      .def("GetAtomType",
           py::overload_cast<int32_t>(&Forcefield::GetAtomType, py::const_))
      .def("NumAtomTypes", &Forcefield::NumAtomTypes)
      .def("GetBondType", py::overload_cast<BondType, int32_t>(
                              &Forcefield::GetBondType, py::const_))
      .def("GetBondType",
           py::overload_cast<int32_t>(&Forcefield::GetBondType, py::const_))
      .def("NumBondTypes",
           py::overload_cast<>(&Forcefield::NumBondTypes, py::const_))
      .def("NumBondTypes",
           py::overload_cast<BondType>(&Forcefield::NumBondTypes, py::const_))
      .def("GetAngleType", py::overload_cast<AngleType, int32_t>(
                               &Forcefield::GetAngleType, py::const_))
      .def("GetAngleType",
           py::overload_cast<int32_t>(&Forcefield::GetAngleType, py::const_))
      .def("NumAngleTypes",
           py::overload_cast<>(&Forcefield::NumAngleTypes, py::const_))
      .def("NumAngleTypes",
           py::overload_cast<AngleType>(&Forcefield::NumAngleTypes, py::const_))
      .def("GetDihedralType", py::overload_cast<DihedralType, int32_t>(
                                  &Forcefield::GetDihedralType, py::const_))
      .def("GetDihedralType",
           py::overload_cast<int32_t>(&Forcefield::GetDihedralType, py::const_))
      .def("NumDihedralTypes",
           py::overload_cast<>(&Forcefield::NumDihedralTypes, py::const_))
      .def("NumDihedralTypes", py::overload_cast<DihedralType>(
                                   &Forcefield::NumDihedralTypes, py::const_))
