...
void GeneratePyForcefield(py::module& m) {
  ...
  .def("GetAtomType", py::overload_cast<std::string>(&IXForcefield::GetAtomType, py::const_))
  .def("GetAtomType", py::overload_cast<int>(&IXForcefield::GetAtomType, py::const_))
  .def("ReserveAtomTypes", &IXForcefield::ReserveAtomTypes)
  .def("NumAtomTypes", &IXForcefield::NumAtomTypes)
  // Bonds
  .def("NewBondType", py::overload_cast<BondType, int, double, double>(&IXForcefield::NewBondType))
  .def("GetBondType", py::overload_cast<BondType, int>(&IXForcefield::GetBondType, py::const_))
  .def("GetBondType", py::overload_cast<int>(&IXForcefield::GetBondType, py::const_))
  ...
  // Angles
  .def("NewAngleType", py::overload_cast<AngleType, int, double, double>(&IXForcefield::NewAngleType))
  .def("GetAngleType", py::overload_cast<AngleType, int>(&IXForcefield::GetAngleType, py::const_))
  .def("GetAngleType", py::overload_cast<int>(&IXForcefield::GetAngleType, py::const_))
  ...
  // Dihedrals
  .def("NewDihedralType", py::overload_cast<DihedralType, int, double, double, double>(&IXForcefield::NewDihedralType))
  .def("NewDihedralType", py::overload_cast<DihedralType, int, double, double>(&IXForcefield::NewDihedralType))
  .def("GetDihedralType", py::overload_cast<DihedralType, int>(&IXForcefield::GetDihedralType, py::const_))
  .def("GetDihedralType", py::overload_cast<int>(&IXForcefield::GetDihedralType, py::const_))
